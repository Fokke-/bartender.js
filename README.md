...
```html
<link rel="stylesheet" href="https://unpkg.com/@fokke-/bartender.js@1.0.6/dist/bartender.min.css">
```
...
```html
<!-- Standard build -->
<script src="https://unpkg.com/@fokke-/bartender.js@1.0.6/dist/bartender.min.js"></script>

<!-- Compatibility build with IE11 support -->
<script src="https://unpkg.com/@fokke-/bartender.js@1.0.6/dist/bartender.compat.js"></script>
```
